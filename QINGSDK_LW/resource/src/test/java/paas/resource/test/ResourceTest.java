...
import paas.common.utils.PropertiesConfig;
...
public class ResourceTest {
    ...
    public void register(){
        ...
        ResourceRegisterResponse response = resource.register("service1",
                "serviceproviderExample11","310101", 1, "v1.0",
                "", "", "ukhkj",
    ...
    public void publish(){
        ResourceImpl resource = new ResourceImpl();
        ResourcePublishResponse response = resource.publish("appsr-0onrowmf",ContextHelper.constAccessToken);
    ...
    public void revoke(){
         ...
         */
        ResourceRevokeResponse response = resource.revoke("appsr-0onrowmf",ContextHelper.constAccessToken);
        logger.info("------------------------");
        System.out.println("response.taskStatus=" + response.getTaskStatus());
        System.out.println("response.serviceId=" + response.getServiceId());
        System.out.println("response.errorMsg="+ response.getErrorMsg());
    ...
    public void modify(){
         ...
         * @return
         */
        ResourceModifyResponse response = resource. modify("appsr-0onrowmf", "serviceNameExample1",
    ...
    public void unregister(){
         ...
         * @return
         */
        ResourceUnregisterResponse response = resource.unregister("appsr-0onrowmf",ContextHelper.constAccessToken);
        System.out.println("TaskStatus: "+response.getTaskStatus());
        System.out.println("ErrorCode :"+response.getErrorCode());
        System.out.println("ErrorMsg : " +response.getErrorMsg());
    }
    ...
    @Test
    public void testProprties(){

        //PropertiesConfig.readData("protocol");
